...
_G.packer_plugins = {
  ale = {
    loaded = true,
    path = "/home/khanghoang/.local/share/nvim/site/pack/packer/start/ale"
  },
  ["bclose.vim"] = {
    loaded = true,
  ...
  harpoon = {
    loaded = true,
    path = "/home/khanghoang/.local/share/nvim/site/pack/packer/start/harpoon"
  },
  ...
  playground = {
    loaded = true,
    path = "/home/khanghoang/.local/share/nvim/site/pack/packer/start/playground"
  },
  ["plenary.nvim"] = {
    loaded = true,
  ...
  ["tig-explorer.vim"] = {
    loaded = true,
    path = "/home/khanghoang/.local/share/nvim/site/pack/packer/start/tig-explorer.vim"
  },
  ["tree-sitter-typescript"] = {
    loaded = true,
    path = "/home/khanghoang/.local/share/nvim/site/pack/packer/start/tree-sitter-typescript"
  },
  ["vifm.vim"] = {
    loaded = true,
  ...
  ["vim-dispatch"] = {
    loaded = true,
    path = "/home/khanghoang/.local/share/nvim/site/pack/packer/start/vim-dispatch"
  },
  ["vim-easymotion"] = {
    loaded = true,
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/home/khanghoang/.local/share/nvim/site/pack/packer/start/vim-gitgutter"
  },
  ["vim-rhubarb"] = {
    loaded = true,
